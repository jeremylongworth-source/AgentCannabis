---
name: master-grower-support
description: "Coordinate AgentCannabis member workflows for master grower support; review assistance only."
license: MIT
metadata:
  family: "professional"
  tier: "composition"
  ...
  responsible_role: "master grower support"
...
Use this professional skillset when the user asks for master grower support support involving crop-cycle evidence, plant health, environment records, and production variance review without optimization instructions. Select relevant member workflows from [the member index](references/member-index.json) and apply only the parts needed for the supplied records.
...
Return a master grower support review brief with selected member workflows, evidence status, gaps, conflicts, source freshness, risk route, and responsible human next steps. This is not legal certification, engineering approval, lot release, report submission, or authorization to operate.
