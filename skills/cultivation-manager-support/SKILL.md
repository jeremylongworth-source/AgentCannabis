---
name: cultivation-manager-support
description: "Coordinate AgentCannabis member workflows for cultivation manager support; review assistance only."
license: MIT
metadata:
  family: "professional"
  tier: "composition"
  ...
  responsible_role: "cultivation manager support"
...
Use this professional skillset when the user asks for cultivation manager support support involving cultivation governance, capacity, deviations, people/role evidence, and safety escalation. Select relevant member workflows from [the member index](references/member-index.json) and apply only the parts needed for the supplied records.
...
Return a cultivation manager support review brief with selected member workflows, evidence status, gaps, conflicts, source freshness, risk route, and responsible human next steps. This is not legal certification, engineering approval, lot release, report submission, or authorization to operate.
