---
name: post-harvest-manager
description: "Coordinate AgentCannabis member workflows for post-harvest manager; review assistance only."
license: MIT
metadata:
  family: "professional"
  tier: "composition"
  ...
  responsible_role: "post-harvest manager"
...
Use this professional skillset when the user asks for post-harvest manager support involving post-harvest workflow control, holds, quality packages, inventory, deviations, and complaints. Select relevant member workflows from [the member index](references/member-index.json) and apply only the parts needed for the supplied records.
...
Licence requirements depend on the selected member workflow and the actual site evidence. The responsible review role for this composition is post-harvest manager; regulated approvals, filings, release decisions, recall decisions, and engineering conclusions remain with authorized humans or qualified professionals.
...
Return a post-harvest manager review brief with selected member workflows, evidence status, gaps, conflicts, source freshness, risk route, and responsible human next steps. This is not legal certification, engineering approval, lot release, report submission, or authorization to operate.
