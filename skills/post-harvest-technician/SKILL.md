---
name: post-harvest-technician
description: "Coordinate AgentCannabis member workflows for post-harvest technician; review assistance only."
license: MIT
metadata:
  family: "professional"
  tier: "composition"
  ...
  responsible_role: "post-harvest technician"
...
Use this professional skillset when the user asks for post-harvest technician support involving harvest identity, intake, handling, drying, curing, and quality-record gaps. Select relevant member workflows from [the member index](references/member-index.json) and apply only the parts needed for the supplied records.
...
Return a post-harvest technician review brief with selected member workflows, evidence status, gaps, conflicts, source freshness, risk route, and responsible human next steps. This is not legal certification, engineering approval, lot release, report submission, or authorization to operate.
