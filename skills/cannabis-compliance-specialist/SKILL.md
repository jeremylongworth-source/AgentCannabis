...
description: "Coordinate AgentCannabis member workflows for cannabis compliance specialist; review assistance only."
license: MIT
metadata:
  family: "professional"
  tier: "composition"
  ...
  responsible_role: "cannabis compliance specialist"
...
Use this professional skillset when the user asks for cannabis compliance specialist support involving licence, role, product, inventory, reporting, complaints, safety, and audit evidence. Select relevant member workflows from [the member index](references/member-index.json) and apply only the parts needed for the supplied records.
...
Return a cannabis compliance specialist review brief with selected member workflows, evidence status, gaps, conflicts, source freshness, risk route, and responsible human next steps. This is not legal certification, engineering approval, lot release, report submission, or authorization to operate.
