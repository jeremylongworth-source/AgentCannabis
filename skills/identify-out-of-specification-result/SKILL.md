---
name: identify-out-of-specification-result
description: "Identify out of specification result using supplied evidence, current-source checks, and the repository's review-only authority boundaries. Use for identify out of specification result; review assistance only."
license: MIT
metadata:
  family: "14"
  tier: "CORE"
...
Identify out of specification result using supplied evidence, current-source checks, and the repository's review-only authority boundaries.
